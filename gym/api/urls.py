...
urlpatterns = [
    ...
    path('gym/review/<str:action>/<str:gym_id>/', Review_action.as_view()),
    path('gym/review/<str:action>/<str:gym_id>/<int:review_id>/', Review_action.as_view()),
    path('gym/timing/<str:action>/', timing_view.as_view()),
    path('gym/timing/<str:action>/<int:timing_id>/', timing_view.as_view()),
